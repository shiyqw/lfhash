...
template <typename T>
BenchmarkLFHashMap<T>::BenchmarkLFHashMap(int num_ops, float load_factor) {
...
template <typename T>
BenchmarkLFHashMap<T>::~BenchmarkLFHashMap() {

	delete[] m_random_keys;
}

template <typename T>
void BenchmarkLFHashMap<T>::benchmark_random_interleaved_read_write() {

	std::cout << "TODO: Interleaved Reads / Writes" << std::endl;
}

template <typename T>
void BenchmarkLFHashMap<T>::benchmark_read_only() {
...
template <typename T>
void BenchmarkLFHashMap<T>::benchmark_write_only() {

	std::cout << "TODO: Write Only" << std::endl;
}

template <typename T>
void BenchmarkLFHashMap<T>::benchmark_read_only_single_bucket() {
